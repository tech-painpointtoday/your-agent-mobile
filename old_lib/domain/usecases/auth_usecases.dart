...
class SignInWithEmail {
  ...
  Future<Either<Failure, User>> call(SignInParams params) async {
    return await repository.signInWithEmail(email: params.email, password: params.password, role: params.role);
  }
}
...
class SignInParams extends Equatable {
  ...
  const SignInParams({required this.email, required this.password, required this.role});
