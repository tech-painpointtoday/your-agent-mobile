...
class DependencyInjection {
  ...
  // Singleton instances - using factory constructors where available
  ...
  static final FengShuiApiService _fengShuiApiService = FengShuiApiService(
    _apiClient,
  );
  static final PlacesService _placesService = PlacesService();
  ...
  static final FloorPlanApiService _floorPlanApiService = FloorPlanApiService(
    _apiClient,
  );
  static final AgentApiService _agentApiService = AgentApiService(_apiClient);
  static final ContractApiService _contractApiService = ContractApiService(
    _apiClient,
  );
  static final AvailabilityApiService _availabilityApiService =
      AvailabilityApiService(_apiClient);
  ...
  static void init(BuildContext context) {
    ...
    // For now, we'll use it as a reference for what needs to be provided
  }
  ...
  static FengShuiApiService get fengShuiApiService => _fengShuiApiService;

  static PlacesService get placesService => _placesService;
  ...
  static FloorPlanApiService get floorPlanApiService => _floorPlanApiService;

  static PusherService get pusherService => PusherService();

  static AgentApiService get agentApiService => _agentApiService;

  static ContractApiService get contractApiService => _contractApiService;

  static AvailabilityApiService get availabilityApiService =>
