...
class MockPropertyData {
  static final List<Property> mockProperties = [
    Property(
      ...
      address:
          '123 ซอยสุขุมวิท 101, แขวงบางจาก, เขตพระโขนง, กรุงเทพมหานคร 10260',
      latitude: 13.7563,
      longitude: 100.5018,
      price: 15000000,
  ...
  static List<Property> getPropertiesByStatus(PropertyStatus status) {
    return mockProperties.where((p) => p.status == status).toList();
  }
}
